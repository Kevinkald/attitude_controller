...
{
int dummy;
/** Matrix of size: 201 x 13 (row major format)
 * 
...
/** Matrix of size: 201 x 8 (row major format)
 * 
 *  Matrix containing 201 online data vectors.
 */
real_t od[ 1608 ];

/** Column vector of size: 2400
 * 
 *  Matrix containing 200 reference/measurement vectors of size 12 for first 200 nodes.
 */
real_t y[ 2400 ];
...
/** Matrix of size: 2 x 234 (row major format) */
real_t rk_diffsTemp2[ 468 ];
...
/** Matrix of size: 2600 x 13 (row major format) */
real_t evGx[ 33800 ];

/** Matrix of size: 2600 x 5 (row major format) */
real_t evGu[ 13000 ];

/** Column vector of size: 306 */
real_t objAuxVar[ 306 ];

/** Row vector of size: 26 */
real_t objValueIn[ 26 ];

/** Row vector of size: 228 */
real_t objValueOut[ 228 ];

/** Matrix of size: 2600 x 13 (row major format) */
real_t Q1[ 33800 ];

/** Matrix of size: 2600 x 12 (row major format) */
real_t Q2[ 31200 ];

/** Matrix of size: 1000 x 5 (row major format) */
real_t R1[ 5000 ];

/** Matrix of size: 1000 x 12 (row major format) */
real_t R2[ 12000 ];
...
/** Matrix of size: 261300 x 5 (row major format) */
real_t E[ 1306500 ];
...
/** Matrix of size: 1000 x 1000 (row major format) */
real_t H[ 1000000 ];

/** Matrix of size: 800 x 1000 (row major format) */
real_t A[ 800000 ];
